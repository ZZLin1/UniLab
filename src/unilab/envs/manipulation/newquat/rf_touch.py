...
class NewquatRFTouchDRProvider(DomainRandomizationProvider):
...
class NewquatRFTouchEnv(Go2BaseEnv):
    ...
    def __init__(self, cfg: NewquatRFTouchCfg, num_envs: int = 1, backend_type: str = "mujoco"):
        ...
        self._init_domain_randomization(NewquatRFTouchDRProvider())

    @property
    def obs_groups_spec(self) -> dict[str, int]:
        return {"obs": 45, "critic": 45}
